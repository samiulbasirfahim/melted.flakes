{...}: let
  theme = ''
    ...
    @define-color theme_unfocused_selected_bg_color @color2;
    /* text/foreground color of selections on backdrop windows */
    @define-color theme_unfocused_selected_fg_color rgba(0, 0, 0, 0.87);
    /* insensitive color on backdrop windows */
    @define-color unfocused_insensitive_color rgba(245, 224, 220, 0.5);
    /* widgets main borders color */
    @define-color borders @color2
    /* widgets main borders color on backdrop windows */
    @define-color unfocused_borders @color2
    ...
    @define-color wm_unfocused_title rgba(245, 224, 220, 0.7);
    @define-color wm_highlight @background;
    @define-color wm_bg @background;
    @define-color wm_unfocused_bg @background;
    @define-color wm_button_close_icon @background;
    @define-color wm_button_close_hover_bg @color2;
    ...
    @define-color budgie_tasklist_indicator_color @foreground;
    @define-color budgie_tasklist_indicator_color_active @foreground;
    ...
    @define-color accent_color @color2;
    ...
    @define-color headerbar_border_color @color2
    ...
    @keyframes ripple-on-headerbar {
      from {
        background-image: radial-gradient(circle, @color2 0%, transparent 0%);
      }
      to {
        background-image: radial-gradient(circle, @color2 100%, transparent 0%);
      }
    }
    ...
    * {
      ...
      -gtktextview-error-underline-color: @color6;
      ...
      -gtk-secondary-caret-color: @color2;
    }
    ...
    *:disabled {
    ...
    label.osd {
      border-radius: 6px;
      background-color: rgba(30, 30, 37, 0.9);
      color: @foreground;
    }
    ...
    entry {
      ...
      background-color: rgba(245, 224, 220, 0.08);
      color: @foreground;
    }
    ...
    entry.warning:focus {
      background-color: rgba(245, 224, 220, 0.08);
      box-shadow: inset 0 0 0 2px #f9e2af;
    }
    ...
    button:disabled {
      box-shadow: none;
      background-color: rgba(245, 224, 220, 0.04);
      color: rgba(245, 224, 220, 0.5);
    }
    ...
    *:visited {
    ...
    button.combo:only-child:focus {
      background-color: alpha(currentColor, 0.08);
      box-shadow: inset 0 0 0 2px rgba(245, 224, 220, 0.3);
    }
    ...
    .titlebar
      ...
      box-shadow: inset 0 0 0 9999px rgba(245, 224, 220, 0.08);
      background-image: radial-gradient(
        circle,
        rgba(245, 224, 220, 0.08) 10%,
        transparent 0%
      );
    }
    ...
    .titlebar.selection-mode {
      ...
      box-shadow: inset 0 1px rgba(245, 224, 220, 0);
      background-color: @color2;
      color: rgba(0, 0, 0, 0.87);
    }
    ...
    .titlebar.default-decoration {
      min-height: 24px;
      padding: 10px 15px;
      box-shadow: inset 0 1px @background;
      border-radius: 12px 12px 0 0;
    }
     ...
     **************/
    treeview.view {
      border-left-color: rgba(245, 224, 220, 0.3);
    ...
    * {
    ...
    .csd popover.background {
      border: 1px solid rgba(245, 224, 220, 0.2);
    ...
    * {
    ...
    scrollbar slider {
      ...
      border-radius: 9999px;
      background-clip: padding-box;
      background-color: rgba(245, 224, 220, 0.2);
    }

    scrollbar slider:hover {
      background-color: rgba(245, 224, 220, 0.3);
    }
    ...
    switch {
      ...
      margin: 6px 0;
      padding: 0;
      border: 2px solid rgba(245, 224, 220, 0.7);
      border-radius: 9999px;
      background-color: transparent;
      background-clip: border-box;
      font-size: 0;
    ...
    scale highlight {
      ...
      background-image: image(@color2);
    }

    scale highlight:disabled {
      background-color: @background;
      background-image: image(rgba(245, 224, 220, 0.3));
    }
    ...
    scale slider:hover {
      box-shadow: inset 0 0 0 2px @color2, 0 0 0 8px @color2
    }

    scale slider:active {
      box-shadow: inset 0 0 0 4px @color2, 0 0 0 8px @color2
    }
    ...
    *****************/
    ...
    paned > separator {
      ...
      border-style: none;
      background-color: transparent;
      background-image: image(rgba(245, 224, 220, 0.12));
    ...
    button.titlebutton.close:not(.suggested-action):not(.destructive-action):active {
    ...
    stackswitcher.linked:not(.vertical)
      ...
      box-shadow: inset 0 0 0 9999px alpha(@color2, 0.08);
      background-image: radial-gradient(
        circle,
        alpha(@color2, 0.08) 10%,
        transparent 0%
      );
    }
    ...
    .nautilus-window.background.csd notebook scrolledwindow .view:selected {
      background-color: rgba(245, 224, 220, 0.20);
    }
    ...
    .tweak-group-@foreground,
    .tweak-@foreground,
    .tweak-@foreground:hover {
    ...
    docktab {
      ...
      background-image: radial-gradient(circle, @color2 10%, transparent 0%);
      background-repeat: no-repeat;
      background-position: center;
      background-size: 0% 0%;
      color: rgba(245, 224, 220, 0.7);
    ...
    window.background.csd.unified > decoration-overlay {
      box-shadow: inset 0 0 0 1px rgba(245, 224, 220, 0.2);
    }
    ...
    #MozillaGtkWidget > widget > entry:focus {
      border-color: @color2;
      box-shadow: inset 0 0 0 1px @color2;
    }
    ...
    UnityDecoration {
      ...
      -unitydecoration-glow-color: @color2;
    ...
    .budgie-panel button.budgie-menu-launcher:hover image {
      background-image: image(rgba(245, 224, 220, 0.2));
    }
    ...
    .budgie-panel button.budgie-menu-launcher:checked image {
      background-image: image(rgba(245, 224, 220, 0.28));
    }
    ...
    .raven .audio-widget list.devices-list.sound-devices > row.activatable:checked {
      background-color: rgba(245, 224, 220, 0.06);
      color: @foreground;
    }
    ...
    .places-treeview {
      -nemoplacestreeview-disk-full-bg-color: #6C7086;
      -nemoplacestreeview-disk-full-fg-color: @color2;
