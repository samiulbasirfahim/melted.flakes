...
let
  pywal = ''
    ...
    if os.path.isfile(colors_absolute):
        ...
        ## Type: QssColor
        c.colors.messages.info.bg = colors['colors']['color1']

        ## Border color of an info message.
        ## Type: QssColor
        c.colors.messages.info.border = colors['colors']['color1']
        ...
        ## Type: QssColor
        c.colors.statusbar.passthrough.bg = colors['colors']['color1']
        ...
        ## Type: QssColor
        c.colors.statusbar.url.hover.fg = colors['colors']['color1']
        ...
        # ## Type: QtColor
        c.colors.tabs.selected.even.bg = colors['colors']['color1']
        ...
        # ## Type: QtColor
        c.colors.tabs.selected.odd.bg = colors['colors']['color1']
...
in {
  programs.qutebrowser = {
    ...
    extraConfig = pywal;
    settings = { colors.webpage.preferred_color_scheme = "dark"; };
  };
}
